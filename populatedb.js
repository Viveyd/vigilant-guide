...
const BookCopy = require("./models/book_copy.js");
...
async function bookCopyCreate(index, book, imprint, due_back, status) {
  ...
  await bookCopy.save();
  bookCopies[index] = bookCopy;
  console.log(`Added copy of a book: ${imprint}`);
}
...
async function createBookCopies() {
  console.log("Adding authors");
  await Promise.all([
    bookCopyCreate(0, books[0], "London Gollancz, 2014.", false, "Available"),
    bookCopyCreate(1, books[1], " Gollancz, 2011.", false, "Loaned"),
    bookCopyCreate(2, books[2], " Gollancz, 2015.", false, false),
    bookCopyCreate(
      3,
      books[3],
    ...
    bookCopyCreate(9, books[0], "Imprint XXX2", false, false),
    bookCopyCreate(10, books[1], "Imprint XXX3", false, false),
  ]);
}
